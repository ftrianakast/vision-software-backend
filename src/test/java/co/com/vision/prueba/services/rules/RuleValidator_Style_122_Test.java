...
import co.com.vision.prueba.domain.rules.Rule_Style_122;
...
public class RuleValidator_Style_122_Test {
	@Inject
	...
	public static Archive<?> createTestArchive() {
		return ShrinkWrap.create(WebArchive.class, "test.war").addClasses(
				RuleValidator.class, Rule_Style_122.class,
